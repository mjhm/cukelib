...
module.exports = function () {
  ...
  this.Given(/^"([^"]*)" is "([^"]*)" Throws$/,
    throwStep(contextSupport.assignString, Error, 'expected assigment to throw'));
  this.Given(/^"([^"]*)" is \(([^"]*)\) Throws$/,
    throwStep(contextSupport.assignNumber, Error, 'expected assigment to throw'));
};
