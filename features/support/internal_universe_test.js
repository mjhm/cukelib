...
const universe = require('../../lib/util/universe');
...
module.exports = function () {
  ...
  universe.initializeUniverse.call(this, {
  ...
  this.Before({ tags: ['@InternalUniverseTest'] }, () => {
    // The universe functions are now in the context of the seenario's World which was copied from
    // the universe.
