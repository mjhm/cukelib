...
var makeQueryRequest = function (methodStr, route, data) {
  var method = methodStr.slice(0, -1);
  ...
  if (typeof data === 'string') {
    request.requestOptions.body = data;
  }
  request.requestPromise = requestPromise(request.requestOptions);
  return request.requestPromise;
};
...
module.exports = {
  ...
  withQueryPayload: function (methodStr, route, data) {
    return makeQueryRequest.call(this, methodStr, route, data);
  },
